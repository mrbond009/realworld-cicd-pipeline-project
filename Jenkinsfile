    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                mvn sonar:sonar \
                 -Dsonar.projectKey=updated-key \
                 -Dsonar.host.url=http://35.174.138.120:9000 \
                 -Dsonar.login=9d03d7c3b57b4b32d9def5e99f40b4dca6c4db0e
                """
                }
            }
        }
